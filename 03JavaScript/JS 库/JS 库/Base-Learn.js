...
// Prototype
// MooTools
// 所有这些框架都提供针对常见 JavaScript 任务的函数
// 包括动画、DOM 操作以及 Ajax 处理
...
// 其他框架
// 下面是其他一些在上面未涉及的框架:
// YUI - Yahoo! User Interface Framework,涵盖大量函数的大型库
// 从简单的 JavaScript 功能到完整的 internet widget。
...
// CDN - 内容分发网络
// 总是希望网页可以尽可能地快。希望页面的容量尽可能地小,同时希望浏览器尽可能多地进行缓存。
...
// 在网页中使用 JavaScript 框架库,只需在 <script> 标签中引用该库即可:
/*
引用 jQuery
...
//使用框架
// 在决定为网页使用 JavaScript 框架之前,首先对框架进行测试是明智的。
